import{d as e,h as t,l as n,n as r,u as i}from"./fs-access-BzDvih72-I3HNOLAJ.js";import{C as a,D as o,E as s,G as c,I as l,M as u,N as d,P as f,T as p,V as m,W as h,_ as g,a as _,ct as v,it as y,lt as b,n as x,w as S}from"./dist-CTW-D1vo.js";import"./lit-DKI5Qpyl.js";var C=class extends y{constructor(...e){super(...e),this.open=!1,this.db=null,this.databaseLabel=``,this.extensions=[],this.loading=!1,this.updatingId=null,this.error=null,this.filterText=``}configure(e){this.db=e.db,this.databaseLabel=e.databaseLabel,this.extensions=[],this.error=null,this.refreshExtensions()}show(){!this.db||!this.db.listDbExtensions||(this.open=!0)}hide(){this.open=!1}async refreshExtensions(){if(!this.db||!this.db.listDbExtensions){this.extensions=[];return}this.loading=!0,this.error=null;try{let e=await a.runAsync(`Loading database extensions`,async()=>this.db.listDbExtensions());this.extensions=Array.isArray(e)?e:[]}catch(e){let t=e instanceof Error?e.message:String(e);this.error=t,h(t)}finally{this.loading=!1}}async enableExtension(e){if(!(!this.db||!this.db.enableDbExtension)){this.updatingId=e.id,this.error=null;try{await a.runAsync(`Enabling extension ${e.label||e.id}`,async()=>this.db.enableDbExtension(e.id)),await this.refreshExtensions()}catch(e){let t=e instanceof Error?e.message:String(e);this.error=t,h(t)}finally{this.updatingId=null}}}async disableExtension(e){if(!(!this.db||!this.db.disableDbExtension)){this.updatingId=e.id,this.error=null;try{await a.runAsync(`Disabling extension ${e.label||e.id}`,async()=>this.db.disableDbExtension(e.id)),await this.refreshExtensions()}catch(e){let t=e instanceof Error?e.message:String(e);this.error=t,h(t)}finally{this.updatingId=null}}}renderExtensionRow(e){let t=!!e.installed,n=t&&!!this.db?.disableDbExtension,r=this.updatingId===e.id;return v`
      ...
      >
        <div class="extension-manager">
          ...
          <div class="extension-list">
            ${this.loading?v`<div class="extension-list-empty">Loading extensions…</div>`:r?S(n,e=>e.id,e=>this.renderExtensionRow(e)):v`
  ...
  `}};o([d({attribute:!1})],D.prototype,`input`,void 0),o([d({type:Boolean})],D.prototype,`readOnly`,void 0),o([u()],D.prototype,`initialContent`,void 0),o([u()],D.prototype,`initialUri`,void 0),o([u()],D.prototype,`running`,void 0),o([u()],D.prototype,`availableAdapters`,void 0),o([u()],D.prototype,`selectedEngineId`,void 0),o([u()],D.prototype,`availableConnections`,void 0),o([u()],D.prototype,`selectedConnectionId`,void 0),D=o([f(`lyra-sql-editor`)],D);function O(){x.registerEditorInputHandler({editorId:`system.sqleditor`,label:`SQL Editor`,icon:`database`,canHandle:e=>e instanceof r&&e.getName().toLowerCase().endsWith(`.sql`),ranking:900,handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:`database`,state:{},component:()=>null};return t.component=e=>v`<lyra-sql-editor id="${e}" .input=${t}></lyra-sql-editor>`,t}})}export{O as default};