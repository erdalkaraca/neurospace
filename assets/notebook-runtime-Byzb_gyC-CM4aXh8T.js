        ...
        `;return l`
            ...
            ${this.kernel?this.kernel.connect?l`
                <wa-button
                    ...
                    title=${n}
                >
                    <wa-icon name="circle" label="Kernel status" style=${g({color:i})}></wa-icon>
                    ${r}
                </wa-button>
            `:l`
...
`).length*19+10),u=i?l`
    ...
    `}};u([p({attribute:!1})],S.prototype,`input`,void 0),u([c()],S.prototype,`notebook`,void 0),u([c()],S.prototype,`cellOutputs`,void 0),u([c()],S.prototype,`executingCells`,void 0),u([c()],S.prototype,`availableKernels`,void 0),u([c()],S.prototype,`selectedKernelId`,void 0),u([c()],S.prototype,`kernel`,void 0),u([c()],S.prototype,`kernelConnected`,void 0),u([c()],S.prototype,`kernelConnecting`,void 0),u([c()],S.prototype,`kernelVersion`,void 0),u([c()],S.prototype,`editingMarkdownCells`,void 0),u([c()],S.prototype,`executionCounter`,void 0),u([c()],S.prototype,`isRunningAll`,void 0),u([c()],S.prototype,`highlightedCellIndex`,void 0),u([c()],S.prototype,`cellHeights`,void 0),S=u([h(`docks-notebook-editor`)],S);export{S as DocksNotebookEditor};