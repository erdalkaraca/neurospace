import{B as e,a as t,d as n,ft as r,j as i,st as a}from"./dist-Be2v51rR.js";var o=class extends t{constructor(...e){super(...e),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){let e=performance.memory;if(!e)return r``;let t=(e.totalJSHeapSize/1048576).toFixed(1),n=(e.jsHeapSizeLimit/1048576).toFixed(0),i=e.totalJSHeapSize/e.jsHeapSizeLimit*100,a=i.toFixed(0);return r`
        ...
        `}};o=i([a(`docks-memory-usage`)],o),e.registerContribution(n,{target:n,label:`Memory`,component:`<docks-memory-usage></docks-memory-usage>`});