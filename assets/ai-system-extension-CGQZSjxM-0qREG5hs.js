const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ai-service-CZ0rzs7t-DY0HT22X.js","assets/main-D5lUwwMN.js","assets/main-DCTlflHk.css"])))=>i.map(i=>d[i]);
import{j as M,d as C,i as je,a as N,o as x,r as E,W as ft,S as He,X as Ye,b as p,f as Ae,l as me,u as Qe,m as Ze,q as Xe,w as Je,E as H,Y as b,J as wt,G as pe,K as Ce,v as j,c as z,y as et,Z as tt,_ as ae,k as fe,g as st,s as de,h as at,t as D,$ as bt,a0 as vt,D as kt,a1 as At,F as yt,Q as St,a2 as xt,a3 as Et,a4 as Tt,a5 as $t,a6 as Ct,a7 as _t,a8 as It,a9 as Ot,aa as Rt,ab as Pt,ac as Mt,ad as Nt,T as Dt,ae as Lt,I as zt,af as Ut,ag as Gt,x as qt,ah as Vt,R as Bt,ai as Kt,aj as Ft,ak as Wt,L as jt,al as Ht,am as Yt,U as Qt,A as Zt,C as Xt,an as Jt,ao as es,M as ts,p as ss,H as as,z as rs,ap as is,aq as ns,ar as os,as as ls}from"./main-D5lUwwMN.js";import{b as S,c as cs,C as ps,K as ye,t as ee,l as rt,n as ds,u as ke,i as hs}from"./ai-service-CZ0rzs7t-DY0HT22X.js";const Ge=Object.freeze(Object.defineProperty({__proto__:null,COMMAND_SAVE:bt,CommandRegistry:vt,Directory:kt,EDITOR_AREA_MAIN:At,File:yt,FileContentType:St,HIDE_DOT_RESOURCE:xt,KContainer:Et,KDialogContent:Tt,KElement:st,KPart:Ce,get KStandardLayout(){return $t},KWidget:Ct,MouseButton:_t,PANEL_BOTTOM:It,SIDEBAR_AUXILIARY:Ye,SIDEBAR_MAIN:Ot,SIDEBAR_MAIN_BOTTOM:Rt,SYSTEM_LANGUAGE_BUNDLES:He,TOOLBAR_BOTTOM:Ae,TOOLBAR_BOTTOM_CENTER:Pt,TOOLBAR_BOTTOM_END:Mt,TOOLBAR_MAIN:Nt,TOOLBAR_MAIN_CENTER:Dt,TOOLBAR_MAIN_RIGHT:Ze,TOPIC_CONTRIBUTEIONS_CHANGED:Lt,TOPIC_SETTINGS_CHANGED:at,TOPIC_WORKSPACE_CHANGED:zt,TOPIC_WORKSPACE_CONNECTED:Ut,WorkspaceService:Gt,activeEditorSignal:qt,activePartSignal:Vt,activeSelectionSignal:Bt,activeTasksSignal:Kt,appLoaderService:Ft,appSettings:M,applyAppHostConfig:Wt,commandRegistry:z,confirmDialog:fe,contributionRegistry:C,createLogger:jt,editorRegistry:me,esmShService:Ht,extensionRegistry:Yt,i18n:je,i18nLazy:Qt,infoDialog:Zt,logger:Xt,packageInfoService:Jt,partDirtySignal:es,persistenceService:ts,promptDialog:ss,publish:as,registerAll:Qe,rootContext:Xe,subscribe:de,taskService:et,toastError:j,toastInfo:rs,toastWarning:is,treeNodeComparator:ns,uiContext:tt,unsubscribe:os,watchSignal:ls,workspaceService:Je},Symbol.toStringTag,{value:"Module"}));function _e(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var F=_e();function it(t){F=t}var se={exec:()=>null};function w(t,e=""){let r=typeof t=="string"?t:t.source,a={replace:(s,n)=>{let i=typeof n=="string"?n:n.source;return i=i.replace($.caret,"$1"),r=r.replace(s,i),a},getRegex:()=>new RegExp(r,e)};return a}var us=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),$={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i")},gs=/^(?:[ \t]*(?:\n|$))+/,ms=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ne=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ws=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Ie=/(?:[*+-]|\d{1,9}[.)])/,nt=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,ot=w(nt).replace(/bull/g,Ie).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),bs=w(nt).replace(/bull/g,Ie).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Oe=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,vs=/^[^\n]+/,Re=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ks=w(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Re).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),As=w(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Ie).getRegex(),we="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Pe=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ys=w("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Pe).replace("tag",we).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),lt=w(Oe).replace("hr",ne).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",we).getRegex(),Ss=w(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",lt).getRegex(),Me={blockquote:Ss,code:ms,def:ks,fences:fs,heading:ws,hr:ne,html:ys,lheading:ot,list:As,newline:gs,paragraph:lt,table:se,text:vs},qe=w("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ne).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",we).getRegex(),xs={...Me,lheading:bs,table:qe,paragraph:w(Oe).replace("hr",ne).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",qe).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",we).getRegex()},Es={...Me,html:w(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Pe).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:se,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:w(Oe).replace("hr",ne).replace("heading",` *#{1,6} *[^
]`).replace("lheading",ot).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ts=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,$s=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ct=/^( {2,}|\\)\n(?!\s*$)/,Cs=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,be=/[\p{P}\p{S}]/u,Ne=/[\s\p{P}\p{S}]/u,pt=/[^\s\p{P}\p{S}]/u,_s=w(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ne).getRegex(),dt=/(?!~)[\p{P}\p{S}]/u,Is=/(?!~)[\s\p{P}\p{S}]/u,Os=/(?:[^\s\p{P}\p{S}]|~)/u,Rs=w(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",us?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ht=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ps=w(ht,"u").replace(/punct/g,be).getRegex(),Ms=w(ht,"u").replace(/punct/g,dt).getRegex(),ut="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ns=w(ut,"gu").replace(/notPunctSpace/g,pt).replace(/punctSpace/g,Ne).replace(/punct/g,be).getRegex(),Ds=w(ut,"gu").replace(/notPunctSpace/g,Os).replace(/punctSpace/g,Is).replace(/punct/g,dt).getRegex(),Ls=w("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,pt).replace(/punctSpace/g,Ne).replace(/punct/g,be).getRegex(),zs=w(/\\(punct)/,"gu").replace(/punct/g,be).getRegex(),Us=w(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Gs=w(Pe).replace("(?:-->|$)","-->").getRegex(),qs=w("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Gs).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),he=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Vs=w(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",he).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),gt=w(/^!?\[(label)\]\[(ref)\]/).replace("label",he).replace("ref",Re).getRegex(),mt=w(/^!?\[(ref)\](?:\[\])?/).replace("ref",Re).getRegex(),Bs=w("reflink|nolink(?!\\()","g").replace("reflink",gt).replace("nolink",mt).getRegex(),Ve=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,De={_backpedal:se,anyPunctuation:zs,autolink:Us,blockSkip:Rs,br:ct,code:$s,del:se,emStrongLDelim:Ps,emStrongRDelimAst:Ns,emStrongRDelimUnd:Ls,escape:Ts,link:Vs,nolink:mt,punctuation:_s,reflink:gt,reflinkSearch:Bs,tag:qs,text:Cs,url:se},Ks={...De,link:w(/^!?\[(label)\]\((.*?)\)/).replace("label",he).getRegex(),reflink:w(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",he).getRegex()},Se={...De,emStrongRDelimAst:Ds,emStrongLDelim:Ms,url:w(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Ve).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:w(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Ve).getRegex()},Fs={...Se,br:w(ct).replace("{2,}","*").getRegex(),text:w(Se.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ce={normal:Me,gfm:xs,pedantic:Es},X={normal:De,gfm:Se,breaks:Fs,pedantic:Ks},Ws={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Be=t=>Ws[t];function P(t,e){if(e){if($.escapeTest.test(t))return t.replace($.escapeReplace,Be)}else if($.escapeTestNoEncode.test(t))return t.replace($.escapeReplaceNoEncode,Be);return t}function Ke(t){try{t=encodeURI(t).replace($.percentDecode,"%")}catch{return null}return t}function Fe(t,e){let r=t.replace($.findPipe,(n,i,l)=>{let o=!1,h=i;for(;--h>=0&&l[h]==="\\";)o=!o;return o?"|":" |"}),a=r.split($.splitPipe),s=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),e)if(a.length>e)a.splice(e);else for(;a.length<e;)a.push("");for(;s<a.length;s++)a[s]=a[s].trim().replace($.slashPipe,"|");return a}function J(t,e,r){let a=t.length;if(a===0)return"";let s=0;for(;s<a&&t.charAt(a-s-1)===e;)s++;return t.slice(0,a-s)}function js(t,e){if(t.indexOf(e[1])===-1)return-1;let r=0;for(let a=0;a<t.length;a++)if(t[a]==="\\")a++;else if(t[a]===e[0])r++;else if(t[a]===e[1]&&(r--,r<0))return a;return r>0?-2:-1}function We(t,e,r,a,s){let n=e.href,i=e.title||null,l=t[1].replace(s.other.outputLinkReplace,"$1");a.state.inLink=!0;let o={type:t[0].charAt(0)==="!"?"image":"link",raw:r,href:n,title:i,text:l,tokens:a.inlineTokens(l)};return a.state.inLink=!1,o}function Hs(t,e,r){let a=t.match(r.other.indentCodeCompensation);if(a===null)return e;let s=a[1];return e.split(`
`).map(n=>{let i=n.match(r.other.beginningSpace);if(i===null)return n;let[l]=i;return l.length>=s.length?n.slice(s.length):n}).join(`
`)}var ue=class{options;rules;lexer;constructor(t){this.options=t||F}space(t){let e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){let e=this.rules.block.code.exec(t);if(e){let r=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?r:J(r,`
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let r=e[0],a=Hs(r,e[3]||"",this.rules);return{type:"code",raw:r,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:a}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let r=e[2].trim();if(this.rules.other.endingHash.test(r)){let a=J(r,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(r=a.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:r,tokens:this.lexer.inline(r)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:J(e[0],`
...
`+a+"</"+s+`>
`}listitem(t){let e="";if(t.task){let r=this.checkbox({checked:!!t.checked});t.loose?t.tokens[0]?.type==="paragraph"?(t.tokens[0].text=r+" "+t.tokens[0].text,t.tokens[0].tokens&&t.tokens[0].tokens.length>0&&t.tokens[0].tokens[0].type==="text"&&(t.tokens[0].tokens[0].text=r+" "+P(t.tokens[0].tokens[0].text),t.tokens[0].tokens[0].escaped=!0)):t.tokens.unshift({type:"text",raw:r+" ",text:r+" ",escaped:!0}):e+=r+" "}return e+=this.parser.parse(t.tokens,!!t.loose),`<li>${e}</li>
...
`}strong({tokens:t}){return`<strong>${this.parser.parseInline(t)}</strong>`}em({tokens:t}){return`<em>${this.parser.parseInline(t)}</em>`}codespan({text:t}){return`<code>${P(t,!0)}</code>`}br(t){return"<br>"}del({tokens:t}){return`<del>${this.parser.parseInline(t)}</del>`}link({href:t,title:e,tokens:r}){let a=this.parser.parseInline(r),s=Ke(t);if(s===null)return a;t=s;let n='<a href="'+t+'"';return e&&(n+=' title="'+P(e)+'"'),n+=">"+a+"</a>",n}image({href:t,title:e,text:r,tokens:a}){a&&(r=this.parser.parseInline(a,this.parser.textRenderer));let s=Ke(t);if(s===null)return P(r);t=s;let n=`<img src="${t}" alt="${r}"`;return e&&(n+=` title="${P(e)}"`),n+=">",n}text(t){return"tokens"in t&&t.tokens?this.parser.parseInline(t.tokens):"escaped"in t&&t.escaped?t.text:P(t.text)}},Le=class{strong({text:t}){return t}em({text:t}){return t}codespan({text:t}){return t}del({text:t}){return t}html({text:t}){return t}text({text:t}){return t}link({text:t}){return""+t}image({text:t}){return""+t}br(){return""}},R=class Ee{options;renderer;textRenderer;constructor(e){this.options=e||F,this.options.renderer=this.options.renderer||new ge,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Le}static parse(e,r){return new Ee(r).parse(e)}static parseInline(e,r){return new Ee(r).parseInline(e)}parse(e,r=!0){let a="";for(let s=0;s<e.length;s++){let n=e[s];if(this.options.extensions?.renderers?.[n.type]){let l=n,o=this.options.extensions.renderers[l.type].call({parser:this},l);if(o!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(l.type)){a+=o||"";continue}}let i=n;switch(i.type){case"space":{a+=this.renderer.space(i);continue}case"hr":{a+=this.renderer.hr(i);continue}case"heading":{a+=this.renderer.heading(i);continue}case"code":{a+=this.renderer.code(i);continue}case"table":{a+=this.renderer.table(i);continue}case"blockquote":{a+=this.renderer.blockquote(i);continue}case"list":{a+=this.renderer.list(i);continue}case"html":{a+=this.renderer.html(i);continue}case"def":{a+=this.renderer.def(i);continue}case"paragraph":{a+=this.renderer.paragraph(i);continue}case"text":{let l=i,o=this.renderer.text(l);for(;s+1<e.length&&e[s+1].type==="text";)l=e[++s],o+=`
`+this.renderer.text(l);r?a+=this.renderer.paragraph({type:"paragraph",raw:o,text:o,tokens:[{type:"text",raw:o,text:o,escaped:!0}]}):a+=o;continue}default:{let l='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return a}parseInline(e,r=this.renderer){let a="";for(let s=0;s<e.length;s++){let n=e[s];if(this.options.extensions?.renderers?.[n.type]){let l=this.options.extensions.renderers[n.type].call({parser:this},n);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(n.type)){a+=l||"";continue}}let i=n;switch(i.type){case"escape":{a+=r.text(i);break}case"html":{a+=r.html(i);break}case"link":{a+=r.link(i);break}case"image":{a+=r.image(i);break}case"strong":{a+=r.strong(i);break}case"em":{a+=r.em(i);break}case"codespan":{a+=r.codespan(i);break}case"br":{a+=r.br(i);break}case"del":{a+=r.del(i);break}case"text":{a+=r.text(i);break}default:{let l='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return a}},te=class{options;block;constructor(t){this.options=t||F}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(t){return t}postprocess(t){return t}processAllTokens(t){return t}emStrongMask(t){return t}provideLexer(){return this.block?O.lex:O.lexInline}provideParser(){return this.block?R.parse:R.parseInline}},Ys=class{defaults=_e();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=R;Renderer=ge;TextRenderer=Le;Lexer=O;Tokenizer=ue;Hooks=te;constructor(...t){this.use(...t)}walkTokens(t,e){let r=[];for(let a of t)switch(r=r.concat(e.call(this,a)),a.type){case"table":{let s=a;for(let n of s.header)r=r.concat(this.walkTokens(n.tokens,e));for(let n of s.rows)for(let i of n)r=r.concat(this.walkTokens(i.tokens,e));break}case"list":{let s=a;r=r.concat(this.walkTokens(s.items,e));break}default:{let s=a;this.defaults.extensions?.childTokens?.[s.type]?this.defaults.extensions.childTokens[s.type].forEach(n=>{let i=s[n].flat(1/0);r=r.concat(this.walkTokens(i,e))}):s.tokens&&(r=r.concat(this.walkTokens(s.tokens,e)))}}return r}use(...t){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return t.forEach(r=>{let a={...r};if(a.async=this.defaults.async||a.async||!1,r.extensions&&(r.extensions.forEach(s=>{if(!s.name)throw new Error("extension name required");if("renderer"in s){let n=e.renderers[s.name];n?e.renderers[s.name]=function(...i){let l=s.renderer.apply(this,i);return l===!1&&(l=n.apply(this,i)),l}:e.renderers[s.name]=s.renderer}if("tokenizer"in s){if(!s.level||s.level!=="block"&&s.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let n=e[s.level];n?n.unshift(s.tokenizer):e[s.level]=[s.tokenizer],s.start&&(s.level==="block"?e.startBlock?e.startBlock.push(s.start):e.startBlock=[s.start]:s.level==="inline"&&(e.startInline?e.startInline.push(s.start):e.startInline=[s.start]))}"childTokens"in s&&s.childTokens&&(e.childTokens[s.name]=s.childTokens)}),a.extensions=e),r.renderer){let s=this.defaults.renderer||new ge(this.defaults);for(let n in r.renderer){if(!(n in s))throw new Error(`renderer '${n}' does not exist`);if(["options","parser"].includes(n))continue;let i=n,l=r.renderer[i],o=s[i];s[i]=(...h)=>{let d=l.apply(s,h);return d===!1&&(d=o.apply(s,h)),d||""}}a.renderer=s}if(r.tokenizer){let s=this.defaults.tokenizer||new ue(this.defaults);for(let n in r.tokenizer){if(!(n in s))throw new Error(`tokenizer '${n}' does not exist`);if(["options","rules","lexer"].includes(n))continue;let i=n,l=r.tokenizer[i],o=s[i];s[i]=(...h)=>{let d=l.apply(s,h);return d===!1&&(d=o.apply(s,h)),d}}a.tokenizer=s}if(r.hooks){let s=this.defaults.hooks||new te;for(let n in r.hooks){if(!(n in s))throw new Error(`hook '${n}' does not exist`);if(["options","block"].includes(n))continue;let i=n,l=r.hooks[i],o=s[i];te.passThroughHooks.has(n)?s[i]=h=>{if(this.defaults.async&&te.passThroughHooksRespectAsync.has(n))return(async()=>{let m=await l.call(s,h);return o.call(s,m)})();let d=l.call(s,h);return o.call(s,d)}:s[i]=(...h)=>{if(this.defaults.async)return(async()=>{let m=await l.apply(s,h);return m===!1&&(m=await o.apply(s,h)),m})();let d=l.apply(s,h);return d===!1&&(d=o.apply(s,h)),d}}a.hooks=s}if(r.walkTokens){let s=this.defaults.walkTokens,n=r.walkTokens;a.walkTokens=function(i){let l=[];return l.push(n.call(this,i)),s&&(l=l.concat(s.call(this,i))),l}}this.defaults={...this.defaults,...a}}),this}setOptions(t){return this.defaults={...this.defaults,...t},this}lexer(t,e){return O.lex(t,e??this.defaults)}parser(t,e){return R.parse(t,e??this.defaults)}parseMarkdown(t){return(e,r)=>{let a={...r},s={...this.defaults,...a},n=this.onError(!!s.silent,!!s.async);if(this.defaults.async===!0&&a.async===!1)return n(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return n(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return n(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(s.hooks&&(s.hooks.options=s,s.hooks.block=t),s.async)return(async()=>{let i=s.hooks?await s.hooks.preprocess(e):e,l=await(s.hooks?await s.hooks.provideLexer():t?O.lex:O.lexInline)(i,s),o=s.hooks?await s.hooks.processAllTokens(l):l;s.walkTokens&&await Promise.all(this.walkTokens(o,s.walkTokens));let h=await(s.hooks?await s.hooks.provideParser():t?R.parse:R.parseInline)(o,s);return s.hooks?await s.hooks.postprocess(h):h})().catch(n);try{s.hooks&&(e=s.hooks.preprocess(e));let i=(s.hooks?s.hooks.provideLexer():t?O.lex:O.lexInline)(e,s);s.hooks&&(i=s.hooks.processAllTokens(i)),s.walkTokens&&this.walkTokens(i,s.walkTokens);let l=(s.hooks?s.hooks.provideParser():t?R.parse:R.parseInline)(i,s);return s.hooks&&(l=s.hooks.postprocess(l)),l}catch(i){return n(i)}}}onError(t,e){return r=>{if(r.message+=`
Please report this to https://github.com/markedjs/marked.`,t){let a="<p>An error occurred:</p><pre>"+P(r.message+"",!0)+"</pre>";return e?Promise.resolve(a):a}if(e)return Promise.reject(r);throw r}}},V=new Ys;function v(t,e){return V.parse(t,e)}v.options=v.setOptions=function(t){return V.setOptions(t),v.defaults=V.defaults,it(v.defaults),v};v.getDefaults=_e;v.defaults=F;v.use=function(...t){return V.use(...t),v.defaults=V.defaults,it(v.defaults),v};v.walkTokens=function(t,e){return V.walkTokens(t,e)};v.parseInline=V.parseInline;v.Parser=R;v.parser=R.parse;v.Renderer=ge;v.TextRenderer=Le;v.Lexer=O;v.lexer=O.lex;v.Tokenizer=ue;v.Hooks=te;v.parse=v;v.options;v.setOptions;v.use;v.walkTokens;v.parseInline;R.parse;O.lex;const Qs=`You are an assistant in a web application with workspace, editors, and AI chat.
...
`;C.registerContribution(S,{target:S,label:"Ollama (Local)",provider:{name:"ollama",model:"gemma3:12b",chatApiEndpoint:"https://<your-server>/v1/chat/completions",apiKey:""}});C.registerContribution(S,{target:S,label:"OpenWebUI (Self Hosted)",provider:{name:"openwebui",model:"gemma3:12b",chatApiEndpoint:"https://<your-server>/api/v1/chat/completion",apiKey:""}});C.registerContribution(S,{target:S,label:"OpenAI",provider:{name:"openai",model:"gpt-4.1",chatApiEndpoint:"https://api.openai.com/v1/chat/completions",apiKey:"<your api key>"}});C.registerContribution(S,{target:S,label:"Groq",provider:{name:"groq",model:"llama-3.1-8b-instant",chatApiEndpoint:"https://api.groq.com/openai/v1/chat/completions",apiKey:"<your api key>"}});C.registerContribution(S,{target:S,label:"Cerebras",provider:{name:"cerebras",model:"llama3.1-8b",chatApiEndpoint:"https://api.cerebras.ai/v1/chat/completions",apiKey:"<your api key>"}});C.registerContribution(S,{target:S,label:"WebLLM",provider:{name:"webllm",model:"gemma-2-9b-it-q4f16_1-MLC",chatApiEndpoint:"",apiKey:"",parameters:{context_window_size:4096}}});C.registerContribution(S,{target:S,label:"Mistral",provider:{name:"mistral",model:"mistral-large-latest",chatApiEndpoint:"https://api.mistral.ai/v1/chat/completions",apiKey:"<your api key>",ocrApiEndpoint:"https://api.mistral.ai/v1/ocr",ocrModel:"mistral-ocr-latest"}});C.registerContribution(S,{target:S,label:"LiteLLM",provider:{name:"litellm",model:"gpt-3.5-turbo",chatApiEndpoint:"https://<your-server>/v1/chat/completions",apiKey:"<your api key>"}});const Zs={enhance:async(t,e)=>{try{const r=await Je.getWorkspace(),a=me.getEditorArea()?.getActiveEditor(),s={workspace:r?.getName()||null,activeEditor:a?{title:a.input?.title||null,editorId:a.input?.editorId||null}:null},n=`***App's state:***
${JSON.stringify(s,null,2)}`;return`${t}

${n}`}catch{return t}},priority:20};C.registerContribution(cs,{label:"App State Enhancer",enhancer:Zs});const c=je("aisystem");var Xs=Object.defineProperty,Js=Object.getOwnPropertyDescriptor,Y=(t,e,r,a)=>{for(var s=a>1?void 0:a?Js(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&Xs(e,r,s),s};let U=class extends H{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(t){navigator.clipboard.writeText(t).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(t){return t.includes("code-block-wrapper")?t:t.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,r,a)=>`<div class="code-block-wrapper">
            ...
            <div class="message-wrapper ${e?"user":"assistant"} ${this.isStreaming?"streaming":""} ${r?"requires-attention":""}">
                ...
                <div class="message-content-wrapper ${e?"user":""}">
                    <div class="message-content">
                        ${wt(this.processMarkdownContent(v.parse(t.content||"")))}
    ...
    `;Y([x({type:Object,attribute:!1})],U.prototype,"message",2);Y([x({type:Boolean})],U.prototype,"isStreaming",2);Y([x({type:Boolean})],U.prototype,"showHeader",2);Y([x({type:Number,attribute:!1})],U.prototype,"messageIndex",2);Y([E()],U.prototype,"attentionInputValue",2);U=Y([D("ai-chat-message")],U);var ea=Object.defineProperty,ta=Object.getOwnPropertyDescriptor,Q=(t,e,r,a)=>{for(var s=a>1?void 0:a?ta(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&ea(e,r,s),s};let G=class extends H{constructor(){super(...arguments),this.value="",this.disabled=!1,this.busy=!1,this.hasProvider=!0}onInput(t){const e=t.target;this.value=e.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value},bubbles:!0,composed:!0}))}onKeyDown(t){t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),this.send())}async send(){if(!this.value.trim()||this.disabled||!this.hasProvider)return;const t=this.value;this.value="",this.requestUpdate(),await this.updateComplete,this.textareaElement&&(this.textareaElement.value="",this.textareaElement.focus()),this.dispatchEvent(new CustomEvent("send",{detail:{value:t},bubbles:!0,composed:!0}))}cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}openSettings(){this.dispatchEvent(new CustomEvent("open-settings",{bubbles:!0,composed:!0}))}render(){return p`
    ...
    `;Q([x({type:String})],G.prototype,"value",2);Q([x({type:Boolean})],G.prototype,"disabled",2);Q([x({type:Boolean})],G.prototype,"busy",2);Q([x({type:Boolean})],G.prototype,"hasProvider",2);Q([ft("wa-textarea")],G.prototype,"textareaElement",2);G=Q([D("ai-chat-input")],G);var sa=Object.defineProperty,aa=Object.getOwnPropertyDescriptor,ze=(t,e,r,a)=>{for(var s=a>1?void 0:a?aa(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&sa(e,r,s),s};let re=class extends H{constructor(){super(...arguments),this.message=c("NO_PROVIDER_CONFIGURED"),this.hint=c("CLICK_SETTINGS_TO_CONFIGURE")}render(){return p`
    ...
    `;ze([x({type:String})],re.prototype,"message",2);ze([x({type:String})],re.prototype,"hint",2);re=ze([D("ai-empty-state")],re);var ra=Object.getOwnPropertyDescriptor,ia=(t,e,r,a)=>{for(var s=a>1?void 0:a?ra(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=i(s)||s);return s};let Te=class extends H{render(){return p`
    ...
    `;Te=ia([D("ai-loading-indicator")],Te);var na=Object.defineProperty,oa=Object.getOwnPropertyDescriptor,oe=(t,e,r,a)=>{for(var s=a>1?void 0:a?oa(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&na(e,r,s),s};let B=class extends H{constructor(){super(...arguments),this.isStreaming=!1,this.groupId=""}renderStatusIcon(t){switch(t){case"streaming":return p`<wa-icon name="spinner" class="spinning"></wa-icon>`;case"completed":return p`<wa-icon name="check-circle" class="status-success"></wa-icon>`;case"error":return p`<wa-icon name="exclamation-circle" class="status-error"></wa-icon>`}}copyToClipboard(t){navigator.clipboard.writeText(t).catch(e=>{console.error("Failed to copy:",e)})}render(){if(!this.agentInfo)return p``;const t=this.message?.requiresAttention&&(this.message.attentionRequests?.length||0)>0;return this.message?p`
                    ...
                    <wa-tab-group 
                        ...
                        ${b(this.sessionManager.getArchivedSessionCount()>0,()=>p`
                            <wa-dropdown 
                                ...
                                <wa-dropdown-item 
                                    @click="${async()=>{const a=this.sessionManager.getArchivedSessionCount(),s=a>1?"s":"";if(await fe(c("DELETE_ALL_CONFIRM",{count:a.toString(),plural:s}))){for(const n of this.sessionManager.getArchivedSessions())await this.sessionManager.permanentlyDeleteSession(n.id);this.requestUpdate()}}}">
    ...
    `;le([E()],K.prototype,"busy",2);le([E()],K.prototype,"inputValue",2);le([E()],K.prototype,"requireToolApproval",2);le([E()],K.prototype,"pendingToolApprovals",2);K=le([D("k-aiview")],K);var fa=Object.getOwnPropertyDescriptor,wa=(t,e,r,a)=>{for(var s=a>1?void 0:a?fa(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=i(s)||s);return s};let $e=class extends st{constructor(){super(...arguments),this.totalUsage={promptTokens:0,completionTokens:0,totalTokens:0,requestCount:0},this.providerUsage={},this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.loadUsage(),this.updateInterval=window.setInterval(()=>{this.loadUsage()},5e3),de(ds,()=>{this.loadUsage()})}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}async loadUsage(){try{this.totalUsage=await ke.getTotalUsage(),this.providerUsage=await ke.getAllProviderUsage(),this.requestUpdate()}catch(t){console.error("Failed to load token usage",t)}}formatNumber(t){return t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t.toString()}async handleReset(){await fe(c("RESET_CONFIRM"))&&(await ke.reset(),await this.loadUsage())}render(){return this.totalUsage.totalTokens>0?p`
            <wa-dropdown
                placement="top-end"
                distance="8">
                <wa-button
