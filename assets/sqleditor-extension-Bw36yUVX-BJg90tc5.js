import{_ as e,d as t,f as n,n as r,p as i}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{A as a,B as o,D as s,F as c,O as l,U as u,W as d,at as f,ct as p,ft as m,j as h,k as g,n as _,o as v,ot as y,pt as b,st as x,tt as S,y as C}from"./dist-DPdFd7_Q.js";import"./lit-DAQWYrzS.js";var w=class extends p{constructor(...e){super(...e),this.open=!1,this.db=null,this.databaseLabel=``,this.extensions=[],this.loading=!1,this.updatingId=null,this.error=null,this.filterText=``}configure(e){this.db=e.db,this.databaseLabel=e.databaseLabel,this.extensions=[],this.error=null,this.refreshExtensions()}show(){!this.db||!this.db.listDbExtensions||(this.open=!0)}hide(){this.open=!1}async refreshExtensions(){if(!this.db||!this.db.listDbExtensions){this.extensions=[];return}this.loading=!0,this.error=null;try{let e=await s.runAsync(`Loading database extensions`,async()=>this.db.listDbExtensions());this.extensions=Array.isArray(e)?e:[]}catch(e){let t=e instanceof Error?e.message:String(e);this.error=t,u(t)}finally{this.loading=!1}}async enableExtension(e){if(!(!this.db||!this.db.enableDbExtension)){this.updatingId=e.id,this.error=null;try{await s.runAsync(`Enabling extension ${e.label||e.id}`,async()=>this.db.enableDbExtension(e.id)),await this.refreshExtensions()}catch(e){let t=e instanceof Error?e.message:String(e);this.error=t,u(t)}finally{this.updatingId=null}}}async disableExtension(e){if(!(!this.db||!this.db.disableDbExtension)){this.updatingId=e.id,this.error=null;try{await s.runAsync(`Disabling extension ${e.label||e.id}`,async()=>this.db.disableDbExtension(e.id)),await this.refreshExtensions()}catch(e){let t=e instanceof Error?e.message:String(e);this.error=t,u(t)}finally{this.updatingId=null}}}renderExtensionRow(e){let t=!!e.installed,n=t&&!!this.db?.disableDbExtension,r=this.updatingId===e.id;return m`
      ...
      >
        <div class="extension-manager">
          ...
          <div class="extension-list">
            ${this.loading?m`<div class="extension-list-empty">Loading extensions…</div>`:r?l(n,e=>e.id,e=>this.renderExtensionRow(e)):m`
  ...
  `}};h([y({attribute:!1})],O.prototype,`input`,void 0),h([y({type:Boolean})],O.prototype,`readOnly`,void 0),h([f()],O.prototype,`initialContent`,void 0),h([f()],O.prototype,`initialUri`,void 0),h([f()],O.prototype,`running`,void 0),h([f()],O.prototype,`availableAdapters`,void 0),h([f()],O.prototype,`selectedEngineId`,void 0),h([f()],O.prototype,`availableConnections`,void 0),h([f()],O.prototype,`selectedConnectionId`,void 0),h([f()],O.prototype,`sqlEngineLoading`,void 0),h([f()],O.prototype,`dbVersion`,void 0),h([f()],O.prototype,`sqlVersionLoading`,void 0),O=h([x(`docks-sql-editor`)],O);function k(){_.registerEditorInputHandler({editorId:`system.sqleditor`,label:`SQL Editor`,icon:`database`,canHandle:e=>e instanceof r&&e.getName().toLowerCase().endsWith(`.sql`),ranking:900,handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:`database`,state:{},component:()=>null};return t.component=e=>m`<docks-sql-editor id="${e}" .input=${t}></docks-sql-editor>`,t}})}export{k as default};