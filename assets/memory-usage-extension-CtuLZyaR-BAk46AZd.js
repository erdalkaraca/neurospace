import{D as e,P as t,V as n,ct as r,i,l as a}from"./dist-BtHoxARz.js";var o=class extends i{constructor(...e){super(...e),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){let e=performance.memory;if(!e)return r``;let t=(e.totalJSHeapSize/1048576).toFixed(1),n=(e.jsHeapSizeLimit/1048576).toFixed(0),i=e.totalJSHeapSize/e.jsHeapSizeLimit*100,a=i.toFixed(0);return r`
        ...
        `}};o=e([t(`lyra-memory-usage`)],o),n.registerContribution(a,{target:a,label:`Memory`,component:`<lyra-memory-usage></lyra-memory-usage>`});