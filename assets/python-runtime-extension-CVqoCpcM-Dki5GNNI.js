const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-BDx_xCVN-DeGPViDR.js","assets/config-BIuWNlpk-BpPn17CW.js","assets/config-BIuWNlpk-Cw9IDlk8.css","assets/pyservice-CXj6dvu6-BMU1apUy.js","assets/package-manager-DTcpwrMr-CNq1jN4P.js","assets/index-DmDJ-VkL.js","assets/notebook-kernel-api--RBL5TaE-2imfStcI.js"])))=>i.map(i=>d[i]);
import{f as h,z as l,B as y,c as g,b as u,F as f,_ as m,C as v}from"./config-BIuWNlpk-BpPn17CW.js";import"./index-DmDJ-VkL.js";import{P as r}from"./pyservice-CXj6dvu6-BMU1apUy.js";import{p as c}from"./package-manager-DTcpwrMr-CNq1jN4P.js";import{T as P}from"./notebook-kernel-api--RBL5TaE-2imfStcI.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new r;const e=await v.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
