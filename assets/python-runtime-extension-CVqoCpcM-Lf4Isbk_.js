const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-BDx_xCVN-CkU8WmZT.js","assets/config-BIuWNlpk-TCd_zOUC.js","assets/config-BIuWNlpk-Cw9IDlk8.css","assets/pyservice-CXj6dvu6-BzqLFeq-.js","assets/package-manager-DTcpwrMr-BL5ft_e7.js","assets/index-Zo_iL3XG.js","assets/notebook-kernel-api--RBL5TaE-2imfStcI.js"])))=>i.map(i=>d[i]);
import{f as h,z as l,B as y,c as g,b as u,F as f,_ as m,C as v}from"./config-BIuWNlpk-TCd_zOUC.js";import"./index-Zo_iL3XG.js";import{P as r}from"./pyservice-CXj6dvu6-BzqLFeq-.js";import{p as c}from"./package-manager-DTcpwrMr-BL5ft_e7.js";import{T as P}from"./notebook-kernel-api--RBL5TaE-2imfStcI.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new r;const e=await v.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
