import{n as e}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{A as t,O as n,a as r,at as i,dt as a,ft as o,it as s,k as c,n as l,ot as u}from"./dist-qu6vhmoJ.js";import"./lit-DrT2Vg5t.js";var d=class extends r{constructor(...e){super(...e),this.loading=!1,this.widgetRef=n(),this.isEditor=!0,this.onContentChange=()=>{this.markDirty(!0)}}async doInitUI(){this.loading=!0,this.error=void 0,this.initialContent=void 0,this.uri=void 0;try{let t=this.input?.data;if(!(t instanceof e))throw Error(`No file input available`);let n=await t.getContents(),r=typeof n==`string`?n:new TextDecoder().decode(n);this.initialContent=r,this.uri=t.getWorkspacePath()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.loading=!1}}save(){let t=this.input?.data;if(!(t instanceof e))return;let n=this.widgetRef.value?.getContent?.()??``;t.saveContents(n),this.markDirty(!1)}doClose(){this.widgetRef.value?.dispose?.()}renderContent(){return this.error?a`<div class="state state-error">${this.error}</div>`:this.loading?a`<div class="state state-loading"><wa-spinner></wa-spinner></div>`:this.initialContent===void 0?a`<div class="monaco-editor-placeholder"></div>`:a`
  ...
  `}};t([i({attribute:!1})],d.prototype,`input`,void 0),t([s()],d.prototype,`loading`,void 0),t([s()],d.prototype,`error`,void 0),t([s()],d.prototype,`initialContent`,void 0),t([s()],d.prototype,`uri`,void 0),d=t([u(`k-bids-editor`)],d);var f=e=>e.getName()===`dataset_description.json`;l.registerEditorInputHandler({editorId:`bids-editor`,label:`BIDS Editor`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:`bids-editor-${e.getWorkspacePath()}`,icon:`pencil`,state:{},component:e=>a`<k-bids-editor id="${e}" .input=${t}></k-bids-editor>`};return t},ranking:1e3});