import{_ as e,f as t,u as n,v as r}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{B as i,D as a,H as o,M as s,N as c,O as l,U as u,a as d,at as f,c as p,ct as m,d as h,ft as g,g as _,it as ee,j as v,lt as y,n as b,o as x,ot as S,pt as C,st as w,v as T,w as te,y as E,z as D}from"./dist-DPdFd7_Q.js";import{a as O,c as k,i as A,l as j,n as M,o as N,r as P,s as F,t as I,u as L}from"./ai-service-Cmafte5S-CtbybHUU.js";import"./lit-DAQWYrzS.js";var R=`You are an assistant in a web application with workspace, editors, and AI chat.
...
`;for(let{label:e,...t}of[{label:`Ollama (Local)`,name:`ollama`,model:`gemma3:12b`,chatApiEndpoint:`https://<your-server>/v1/chat/completions`,apiKey:``},{label:`OpenWebUI (Self Hosted)`,name:`openwebui`,model:`gemma3:12b`,chatApiEndpoint:`https://<your-server>/api/v1/chat/completion`,apiKey:``},{label:`OpenAI`,name:`openai`,model:`gpt-4.1`,chatApiEndpoint:`https://api.openai.com/v1/chat/completions`,apiKey:`<your api key>`},{label:`Groq`,name:`groq`,model:`llama-3.1-8b-instant`,chatApiEndpoint:`https://api.groq.com/openai/v1/chat/completions`,apiKey:`<your api key>`},{label:`Cerebras`,name:`cerebras`,model:`llama3.1-8b`,chatApiEndpoint:`https://api.cerebras.ai/v1/chat/completions`,apiKey:`<your api key>`},{label:`WebLLM`,name:`webllm`,model:`gemma-2-9b-it-q4f16_1-MLC`,chatApiEndpoint:``,apiKey:``,parameters:{context_window_size:4096}},{label:`Mistral`,name:`mistral`,model:`mistral-large-latest`,chatApiEndpoint:`https://api.mistral.ai/v1/chat/completions`,apiKey:`<your api key>`},{label:`LiteLLM`,name:`litellm`,model:`gpt-3.5-turbo`,chatApiEndpoint:`https://<your-server>/v1/chat/completions`,apiKey:`<your api key>`}])i.registerContribution(M,{target:M,label:e,provider:t});i.registerContribution(P,{label:`App State Enhancer`,enhancer:{priority:20,enhance:async(e,t)=>{try{let t=await n.getWorkspace(),r=b.getEditorArea()?.getActiveEditor(),i={workspace:t?.getName()||null,activeEditor:r?{title:r.input?.title||null,editorId:r.input?.editorId||null}:null};return`${e}\n\n***App's state:***\n${JSON.stringify(i,null,2)}`}catch{return e}}}});var z=class{constructor(){this.activeSession=null,this.pastSessions=[]}async load(){let e=await T.get(`aiChatSessions`);if(e){if(e.active&&Array.isArray(e.history))this.activeSession=e.active;else if(e.activeSessionId&&Array.isArray(e.sessions))this.activeSession=e.sessions.find(t=>t.id===e.activeSessionId)||null,this.pastSessions=e.sessions.filter(t=>t.id!==e.activeSessionId);else if(Array.isArray(e.all)){let[t,...n]=e.all.sort((e,t)=>t.updatedAt-e.updatedAt);this.activeSession=t||null,this.pastSessions=n}}}async persist(){let e=[];this.activeSession&&e.push(this.activeSession),e.push(...this.pastSessions),await T.set(`aiChatSessions`,{all:e,activeSessionId:this.activeSession?.id||null})}createSession(){let e={id:`session-${Date.now()}-${Math.random().toString(36).slice(2,9)}`,history:[],title:`New Chat`,createdAt:Date.now(),updatedAt:Date.now()};return this.activeSession&&this.pastSessions.unshift(this.activeSession),this.activeSession=e,this.persist(),e}getActiveSession(){return this.activeSession}getActiveSessionId(){return this.activeSession?.id||``}switchToSession(e){if(this.activeSession?.id===e)return!0;let t=this.pastSessions.findIndex(t=>t.id===e);if(t===-1)return!1;let[n]=this.pastSessions.splice(t,1);return n?(this.activeSession&&this.pastSessions.unshift(this.activeSession),this.activeSession=n,this.persist(),!0):!1}getPastSessions(){return this.pastSessions}deletePastSession(e){let t=this.pastSessions.findIndex(t=>t.id===e);return t!==-1&&(this.pastSessions.splice(t,1),this.persist(),!0)}addMessage(e){this.activeSession&&(this.activeSession.history.push(e),this.activeSession.updatedAt=Date.now(),this.persist())}setTitle(e){this.activeSession&&(this.activeSession.title=e,this.persist())}generateTitle(e){let t=e.trim();return t?t.length<=30?t:t.substring(0,30).trim()+`...`:`New Chat`}deleteActiveAndSwitchToFirst(){this.activeSession&&(this.activeSession=this.pastSessions.shift()||null,this.activeSession||this.createSession(),this.persist())}},B=class{constructor(e){this.streamingMessages=new Map,this.currentIndex=-1,this.pendingUpdate=!1,this.onUpdate=e}createStreamingMessage(e){let t=++this.currentIndex;return this.streamingMessages.set(t,{message:{role:e,content:``},isStreaming:!0}),t}updateStreamingMessage(e,t){let n=this.streamingMessages.get(e);n&&(n.message.content+=t,this.scheduleUpdate())}completeStreamingMessage(e,t){let n=this.streamingMessages.get(e);n&&(n.message=t,n.isStreaming=!1)}removeStreamingMessage(e){this.streamingMessages.delete(e)}findStreamingMessage(e){return Array.from(this.streamingMessages.values()).find(t=>t.message.role===e)?.message}getAllStreamingMessages(){return Array.from(this.streamingMessages.values())}scheduleUpdate(){this.pendingUpdate||(this.pendingUpdate=!0,this.rafHandle=requestAnimationFrame(()=>{this.pendingUpdate=!1,this.onUpdate?.()}))}cancelUpdates(){this.rafHandle!==void 0&&(cancelAnimationFrame(this.rafHandle),this.rafHandle=void 0,this.pendingUpdate=!1)}reset(){this.streamingMessages.clear(),this.cancelUpdates(),this.currentIndex=-1}},V=`aiViewChat`,H=class{constructor(e){this.aiService=e,this.providers=[],this.availableModels=[],this.loadingModels=!1,this.providerFactory=new N}async initialize(){this.providers=await this.aiService.getProviders()||[];let e=await this.aiService.getDefaultProvider();e&&(this.selectedProvider=e)}getProviders(){return this.providers}getSelectedProvider(){return this.selectedProvider}setSelectedProvider(e){this.selectedProvider=e}getAvailableModels(){return this.availableModels}isLoadingModels(){return this.loadingModels}async saveSettings(e,t,n,r,i){let a={...await T.get(V)||{}};r!==void 0&&(a.requireToolApproval=r),i!==void 0&&(a.toolApprovalAllowlist=i),await T.set(V,a);let o=this.providers.find(t=>t.name===e);if(o){let r={...o,model:t,...n!==void 0&&{apiKey:n}};this.selectedProvider=r,await this.updateProviderInAIConfig(e,{model:t,...n!==void 0&&{apiKey:n}}),await this.aiService.setDefaultProvider(e)}}async updateProviderInAIConfig(e,t){let n=await T.get(`aiConfig`)||{};if(!n.providers||!Array.isArray(n.providers))return;let r=n.providers.findIndex(t=>t.name===e);r>=0&&(n.providers[r]={...n.providers[r],...t},await T.set(O,n))}async loadToolApprovalAllowlist(){return(await T.get(V)||{}).toolApprovalAllowlist||[]}async fetchModels(e){let t=this.providers.find(t=>t.name===e);if(t){this.loadingModels=!0,this.availableModels=[];try{let e=this.providerFactory.getProvider(t);this.availableModels=await e.getAvailableModels?.(t)??[]}finally{this.loadingModels=!1}}}},U=class{constructor(){this.groups=new Map}createGroup(e,t,n,r,i){let a=`group-${Date.now()}-${Math.random().toString(36).slice(2,9)}`;this.currentGroupId=a;let o={id:a,sessionId:e,userMessageIndex:t,userMessage:n,timestamp:new Date,agents:new Map,messageIndices:new Map};return r.forEach(e=>{let{label:t,icon:n}=i(e);o.agents.set(e,{role:e,label:t,icon:n,status:`streaming`})}),this.groups.set(a,o),a}getGroup(e){return this.groups.get(e)}updateAgentStatus(e,t,n,r,i){let a=this.groups.get(e);if(!a)return;let o=a.agents.get(t);o&&(o.status=n,r&&(o.message=r),i!==void 0&&(o.messageIndex=i,a.messageIndices.set(t,i)))}getGroupsForSession(e){return Array.from(this.groups.values()).filter(t=>t.sessionId===e)}findGroupForUserMessage(e,t,n){return Array.from(this.groups.values()).find(r=>r.sessionId===e&&r.userMessageIndex===t&&r.userMessage===n)}findGroupForMessage(e,t,n){return Array.from(this.groups.values()).find(r=>r.sessionId===e&&r.messageIndices.get(t)===n)}getCurrentGroupId(){return this.currentGroupId}setCurrentGroupId(e){this.currentGroupId=e}clearCurrentGroup(){this.currentGroupId=void 0}getAllGroups(){return Array.from(this.groups.values())}clearAll(){this.groups.clear(),this.currentGroupId=void 0}},W=class extends m{constructor(...e){super(...e),this.isStreaming=!1,this.showHeader=!0}updated(e){super.updated(e),(e.has(`message`)||!this.hasAttribute(`data-is-user`))&&this.updateAlignment()}updateAlignment(){this.message&&this.setAttribute(`data-is-user`,String(this.message.role===`user`))}copyToClipboard(e){navigator.clipboard.writeText(e).catch(e=>console.error(`Failed to copy:`,e))}processMarkdownContent(e){return e.includes(`code-blocwrapper`)?e:e.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,t,n)=>`
            ...
            <div class="message-wrapper ${t?`user`:`assistant`} ${this.isStreaming?`streaming`:``}">
                ...
                <div class="message-content-wrapper ${t?`user`:``}">
                    <div class="message-content">
                        ${c(this.processMarkdownContent(te(e.content||``)))}
                        ${s(this.isStreaming,()=>g`<span class="streaming-cursor">▋</span>`)}
                    </div>
                    ${s(t,()=>g`
                        <wa-button variant="neutral" appearance="plain" size="s" title="Copy"
                            @click="${()=>this.copyToClipboard(e.content)}">
    ...
    `}};v([S({type:Object,attribute:!1})],W.prototype,`message`,void 0),v([S({type:Boolean})],W.prototype,`isStreaming`,void 0),v([S({type:Boolean})],W.prototype,`showHeader`,void 0),v([S({type:Number,attribute:!1})],W.prototype,`messageIndex`,void 0),W=v([w(`docks-ai-chat-message`)],W);var G=class extends m{constructor(...e){super(...e),this.value=``,this.disabled=!1,this.busy=!1,this.hasProvider=!0}onInput(e){this.value=e.target.value,this.dispatchEvent(new CustomEvent(`input-change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}onKeyDown(e){e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),this.send())}async send(){if(!this.value.trim()||this.disabled||!this.hasProvider)return;let e=this.value;this.value=``,this.requestUpdate(),await this.updateComplete,this.textareaElement&&(this.textareaElement.value=``,this.textareaElement.focus()),this.dispatchEvent(new CustomEvent(`send`,{detail:{value:e},bubbles:!0,composed:!0}))}cancel(){this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}render(){return g`
    ...
    `}};v([S({type:String})],G.prototype,`value`,void 0),v([S({type:Boolean})],G.prototype,`disabled`,void 0),v([S({type:Boolean})],G.prototype,`busy`,void 0),v([S({type:Boolean})],G.prototype,`hasProvider`,void 0),v([ee(`wa-textarea`)],G.prototype,`textareaElement`,void 0),G=v([w(`docks-ai-chat-input`)],G);var K=class extends m{copyToClipboard(e){navigator.clipboard.writeText(e).catch(e=>console.error(`Failed to copy:`,e))}renderStatusIcon(e){switch(e){case`streaming`:return g`<wa-icon name="spinner" class="spinning"></wa-icon>`;case`completed`:return g`<wa-icon name="check-circle" class="status-success"></wa-icon>`;case`error`:return g`<wa-icon name="exclamation-circle" class="status-error"></wa-icon>`}}renderCard(e,t){return t?g`
        ...
        `:g`
            ...
            `}render(){if(!this.group)return g``;let e=Array.from(this.group.agents.values()),t=e.filter(e=>e.status===`completed`).length,n=e.filter(e=>e.status===`streaming`).length,r=e.filter(e=>e.status===`error`).length,i=e.length>0&&t+r===e.length,a=e.length===1;return g`
                ...
                ${s(!a,()=>g`
                    <div class="group-header">
                        ...
                        <span class="status-badge">
                            ${s(n>0,()=>g`<span class="streaming">${n} responding</span>`)}
                            ${s(i,()=>g`<span class="done">All completed (${t})</span>`)}
                        </span>
                    </div>
                `)}
    ...
    `}};v([S({type:Object,attribute:!1})],K.prototype,`group`,void 0),v([S({type:Function,attribute:!1})],K.prototype,`findStreamingMessage`,void 0),K=v([w(`docks-ai-agent-response-group`)],K);var q=class extends m{constructor(...e){super(...e),this.pendingApprovals=new Map}approve(e,t){this.dispatchEvent(new CustomEvent(`approve`,{detail:{approvalId:e,approval:t},bubbles:!0,composed:!0})),t.resolve(!0),this.pendingApprovals.delete(e),this.requestUpdate()}deny(e,t){t.resolve(!1),this.pendingApprovals.delete(e),this.requestUpdate()}formatArgs(e){let t={};try{t=JSON.parse(e)}catch{}return Object.entries(t).map(([e,t])=>`${e}=${JSON.stringify(t)}`).join(`, `)}render(){return this.pendingApprovals.size===0?g``:g`
            <div class="approval-container">
                ${Array.from(this.pendingApprovals.entries()).map(([e,t])=>{let n=t.request.toolCalls,r=n[0],i=n.length===1?`AI wants to execute: ${r?.function.name}()`:`AI wants to execute ${n.length} tools`;return g`
                        <wa-details class="approval-item">
                            ...
                            <div class="approval-detail">
                                ...
                                <ul class="tool-list">
                                    ${l(n,e=>e.id,e=>{let n=this.formatArgs(e.function.arguments||`{}`),r=t.alwaysAllowSelections.get(e.id)||!1;return g`
                                            <li class="tool-item">
    ...
    `}};v([S({type:Map,attribute:!1})],q.prototype,`pendingApprovals`,void 0),q=v([w(`docks-ai-tool-approval`)],q);var J=class extends m{constructor(...e){super(...e),this.message=`No AI provider configured`,this.hint=`Click the settings icon to configure an AI provider`}render(){return g`
    ...
    `}};v([S({type:String})],J.prototype,`message`,void 0),v([S({type:String})],J.prototype,`hint`,void 0),J=v([w(`docks-ai-empty-state`)],J);var ne={running:`spinner`,completed:`check-circle`,failed:`exclamation-circle`,skipped:`forward`,pending:`circle`},re={running:`var(--wa-color-brand-50)`,completed:`var(--wa-color-success-60)`,failed:`var(--wa-color-danger-60)`,skipped:`var(--wa-color-neutral-40)`,pending:`var(--wa-color-neutral-40)`},Y=class extends m{constructor(...e){super(...e),this.expanded=!0}render(){if(!this.plan)return g``;let e=this.plan.steps.filter(e=>e.status===`completed`).length,t=this.plan.steps.length,n=t>0?Math.round(e/t*100):0;return g`
            <div class="taspanel">
    ...
    `}};v([S({type:Object,attribute:!1})],Y.prototype,`plan`,void 0),v([f()],Y.prototype,`expanded`,void 0),Y=v([w(`docks-ai-task-progress-panel`)],Y);var ie={code:`code`,json:`brackets-curly`,"file-list":`list`,plan:`diagram-project`,review:`magnifying-glass`,text:`file-lines`},X=class extends m{constructor(...e){super(...e),this.artifacts=[],this.expanded=!1}render(){return this.artifacts.length===0?g``:g`
                    ...
                    <div class="panel-body">
                        <div class="artifact-list">
                            ${l(this.artifacts,e=>e.id,e=>g`
                                ...
                                ${s(this.selectedArtifact?.id===e.id,()=>g`
    ...
    `}};v([S({type:Array,attribute:!1})],X.prototype,`artifacts`,void 0),v([f()],X.prototype,`expanded`,void 0),v([f()],X.prototype,`selectedArtifact`,void 0),X=v([w(`docks-ai-workspace-panel`)],X);var Z=class extends x{constructor(...e){super(...e),this.sessionManager=new z,this.streamManager=new B(()=>{this.requestUpdate(),this.scrollDebounceTimer&&clearTimeout(this.scrollDebounceTimer),this.scrollDebounceTimer=setTimeout(async()=>{await this.updateComplete,this.scrollToBottom(),this.scrollDebounceTimer=void 0},100)}),this.providerManager=new H(j),this.agentGroupManager=new U,this.busy=!1,this.inputValue=``,this.requireToolApproval=!0,this.showHistory=!1,this.currentArtifacts=[],this.pendingToolApprovals=new Map,this.toolApprovalAllowlist=new Set}async doBeforeUI(){this.subscribe(F,()=>this.onAIConfigChanged()),await this.sessionManager.load(),this.sessionManager.getActiveSession()||this.sessionManager.createSession(),await this.providerManager.initialize(),await this.loadSettings(),this.requestUpdate()}async onAIConfigChanged(){await this.providerManager.initialize(),await this.loadSettings(),this.requestUpdate()}async loadSettings(){let e=await T.get(`aiConfig`)||{};this.requireToolApproval=e.requireToolApproval!==!1;let t=await this.providerManager.loadToolApprovalAllowlist();this.toolApprovalAllowlist=new Set(t)}async scrollToBottom(){await this.updateComplete;let e=this.shadowRoot?.querySelector(`wa-scroller.chat-messages`);if(!e)return;let t=e.shadowRoot?.querySelector(`.scroll-container`);t?t.scrollTop=t.scrollHeight:e.scrollTo&&e.scrollTo({top:e.scrollHeight,behavior:`smooth`})}resetViewState(){this.inputValue=``,this.showHistory=!1,this.currentTaskPlan=void 0,this.currentArtifacts=[],this.requestUpdate()}createNewSession(){this.sessionManager.createSession(),this.resetViewState()}switchToSession(e){this.sessionManager.switchToSession(e)&&this.resetViewState()}deletePastSession(e){this.sessionManager.deletePastSession(e),this.requestUpdate()}async sendMessage(){let e=this.inputValue.trim();!e||this.busy||(this.inputValue=``,await this.handlePrompt(e))}async handleResend(e){!e||e.role!==`user`||await this.handlePrompt(e.content)}cancelStream(){this.abortController?.abort(),this.abortController=void 0,this.busy=!1,this.streamManager.cancelUpdates()}async handlePrompt(e){if(e.startsWith(`/`)){await this.runCommand(e.substring(1));return}let t=this.providerManager.getSelectedProvider();if(!t){u(`Please configure an AI provider in settings`);return}let n=this.sessionManager.getActiveSession();if(!n)return;let i=j.createMessage(e);this.sessionManager.addMessage(i),n.history.length===1&&this.sessionManager.setTitle(this.sessionManager.generateTitle(e)),this.requestUpdate(),await this.updateComplete,this.scrollToBottom(),this.busy=!0,this.currentTaskPlan=void 0,this.currentArtifacts=[],this.abortController=new AbortController;let o=new Map,s={history:[...n.history]},c=n.id,l=D.createExecutionContext(),d=r.createChild({...l}),f=j.getAgentContributions();if(f.length===0){u(`No agents are registered.`),this.busy=!1;return}let p=f.filter(t=>!t.canHandle||t.canHandle({...d.getProxy(),userPrompt:e})).sort((e,t)=>(t.priority||0)-(e.priority||0));if(p.length===0){u(`No agents available. Available: ${f.map(e=>e.role).join(`, `)}`),this.busy=!1;return}let m=p.map(e=>e.role),h=this.sessionManager.getActiveSession();if(!h)return;let g=this.agentGroupManager.createGroup(c,h.history.length-1,i,m,e=>{let t=f.find(t=>t.role===e);return{label:t?.label||e,icon:t?.icon||`robot`}});a.runAsync(`Calling AI assistant`,async()=>j.executeAgentWorkflow({chatContext:s,chatConfig:t,callContext:d,execution:`parallel`,stream:!0,signal:this.abortController.signal,roles:m,requireToolApproval:this.requireToolApproval,onToolApprovalRequest:async(e,t)=>t.toolCalls.every(e=>this.toolApprovalAllowlist.has(e.function.name))?!0:new Promise(n=>{let r=`approval-${Date.now()}-${Math.random().toString(36).slice(2,9)}`,i={role:e,request:t,resolve:n,alwaysAllowSelections:new Map};this.pendingToolApprovals.set(r,i),this.requestUpdate()}),onAgentStart:async e=>{let t=this.streamManager.createStreamingMessage(e);o.set(e,t),this.agentGroupManager.updateAgentStatus(g,e,`streaming`),this.requestUpdate(),await this.updateComplete,this.scrollToBottom()},onToken:(e,t)=>{let n=o.get(e);n!==void 0&&this.streamManager.updateStreamingMessage(n,t)},onAgentComplete:async(e,t)=>{let n=this.sessionManager.getActiveSession();if(!n||n.id!==c)return;let r=o.get(e);if(r!==void 0){this.streamManager.completeStreamingMessage(r,t);let i=n.history.length;this.sessionManager.addMessage(t),o.delete(e),this.streamManager.removeStreamingMessage(r),this.agentGroupManager.updateAgentStatus(g,e,`completed`,t,i),this.requestUpdate(),await this.updateComplete,this.scrollToBottom()}},onAgentError:(e,t)=>{let n=o.get(e);n!==void 0&&(this.streamManager.removeStreamingMessage(n),o.delete(e)),this.agentGroupManager.updateAgentStatus(g,e,`error`,{role:e,content:`Error: ${t.message}`}),this.requestUpdate(),u(`Agent ${e} error: ${t.message}`)}}).then(()=>{this.agentGroupManager.clearCurrentGroup()})).catch(e=>{e?.name!==`AbortError`&&u(`${e}`)}).finally(async()=>{this.busy=!1,this.abortController=void 0,this.streamManager.reset(),this.agentGroupManager.clearCurrentGroup(),this.requestUpdate()})}async runCommand(e){let t=e.trim().split(/\s+/);if(t.length===0)return;let n=t.shift(),r=D.getCommand(n);if(!r){u(`Command not found: ${n}`);return}let i={};t.forEach((e,t)=>{r.parameters?.[t]&&(i[r.parameters[t].name]=e)}),await D.execute(n,D.createExecutionContext(i)),this.requestUpdate()}handleToolApproval(e){let{approvalId:t,approval:n}=e.detail;Array.from(n.alwaysAllowSelections.entries()).filter(([,e])=>e).map(([e])=>e).forEach(e=>this.toolApprovalAllowlist.add(e)),this.pendingToolApprovals.delete(t),this.requestUpdate()}renderMessage(e,t,n=!1){return g`
        ...
        `}renderToolbar(){let e=this.sessionManager.getPastSessions(),t=this.sessionManager.getActiveSession();return g`
                ...
                <wa-scroller class="chat-messages" orientation="vertical">
                    <div class="chat-content">
                        ...
                        `,()=>g`
                            ...
                            ${s(this.busy&&this.streamManager.getAllStreamingMessages().length===0,()=>g`
    ...
    `}};v([f()],Z.prototype,`busy`,void 0),v([f()],Z.prototype,`inputValue`,void 0),v([f()],Z.prototype,`requireToolApproval`,void 0),v([f()],Z.prototype,`showHistory`,void 0),v([f()],Z.prototype,`currentTaskPlan`,void 0),v([f()],Z.prototype,`currentArtifacts`,void 0),v([f()],Z.prototype,`pendingToolApprovals`,void 0),Z=v([w(`docks-aiview`)],Z);var Q=class extends d{constructor(...e){super(...e),this.totalUsage={...A},this.providerUsage={}}connectedCallback(){super.connectedCallback(),this.loadUsage(),t(k,()=>{this.loadUsage()})}async loadUsage(){this.totalUsage=await L.getTotalUsage(),this.providerUsage=await L.getAllProviderUsage(),this.requestUpdate()}formatNumber(e){return e>=1e6?(e/1e6).toFixed(2)+`M`:e>=1e3?(e/1e3).toFixed(1)+`K`:e.toString()}async handleReset(){await E(`Reset all token usage statistics?`)&&(await L.reset(),await this.loadUsage())}renderStatItem(e,t){return g`
            <div class="stat-item">
    ...
    `}};Q=v([w(`docks-token-usage`)],Q);var $=class extends x{constructor(...e){super(...e),this.providers=[],this.defaultProvider=``,this.hasChanges=!1,this.availableModels=[],this.loadingModels=!1,this.requireToolApproval=!0,this.smartToolDetection=!1,this.editingState={},this.providerFactory=new N}async doInitUI(){await this.loadConfig(),t(F,()=>this.loadConfig()),t(_,()=>this.loadConfig())}async loadConfig(){let e=await T.get(O);this.aiConfig=e;let t=i.getContributions(M).map(e=>e.provider),n=e?.providers||[],r=new Set(n.map(e=>e.name));this.providers=[...n,...t.filter(e=>!r.has(e.name))],this.defaultProvider=e?.defaultProvider||``,this.requireToolApproval=e?.requireToolApproval!==!1,this.smartToolDetection=e?.smartToolDetection!==void 0&&e.smartToolDetection,this.editingState={},this.hasChanges=!1,this.markDirty(!1)}getEditValue(e,t){let n=this.editingState[e];if(n&&t in n)return n[t]??``;let r=this.providers[e];return r?r[t]??``:``}setEditValue(e,t,n){this.editingState={...this.editingState,[e]:{...this.editingState[e]||{},[t]:n}},this.providers=this.providers.map((r,i)=>i===e?{...r,[t]:n}:r),this.markDirtyAndUpdate()}markDirtyAndUpdate(){this.hasChanges=!0,this.markDirty(!0)}async fetchModels(e){let t=this.providers[e];if(t){this.loadingModels=!0,this.availableModels=[];try{let e=this.providerFactory.getProvider(t);if(e.getAvailableModels){let n=await e.getAvailableModels(t);this.availableModels=Array.isArray(n)?n:[]}}finally{this.loadingModels=!1}}}async saveConfig(){let e={...this.aiConfig??{},defaultProvider:this.defaultProvider,providers:this.providers,requireToolApproval:this.requireToolApproval,smartToolDetection:this.smartToolDetection};await T.set(O,e),this.aiConfig=e,this.hasChanges=!1,this.markDirty(!1)}async save(){this.hasChanges&&await this.saveConfig()}addProvider(){this.providers=[...this.providers,{name:`new-provider`,model:``,apiKey:``,chatApiEndpoint:``}],this.markDirtyAndUpdate()}async deleteProvider(e){let t=this.providers[e];await E(`Delete provider "${t.name}"?`)&&(this.defaultProvider===t.name&&(this.defaultProvider=``),this.providers=this.providers.filter((t,n)=>n!==e),this.markDirtyAndUpdate())}renderProviderField(e,t,n=`text`){let r=this.getEditValue(e,t);return g`
        ...
        `}renderContent(){return g`
            <div class="editor">
                ...
                ${s(this.providers.length===0,()=>g`
                    <div class="empty-state"><p>No providers configured.</p></div>
                `,()=>g`
                    <div class="providers-list">
                        ${l(this.providers,(e,t)=>t,(e,t)=>g`
                            <div class="provider-card">
                                <div class="provider-card-header ${this.defaultProvider===e.name?`is-default`:``}">
                                    <span class="provider-name">${e.name}</span>
                                    ${this.defaultProvider===e.name?g`<span class="default-badge">Default</span>`:g`<wa-button appearance="plain" size="s" title="Set as default"
                                ...
                                <div class="provider-fields">
                                    ...
                                    <div class="field-row">
                                        ...
                                        ${s(this.loadingModels,()=>g`
                                            <wa-progress-ring indeterminate size="s"></wa-progress-ring>
                                        `)}
                                        ${s(this.availableModels.length>0,()=>g`
                                            <wa-dropdown
    ...
    `}};v([S({attribute:!1})],$.prototype,`input`,void 0),v([f()],$.prototype,`providers`,void 0),v([f()],$.prototype,`defaultProvider`,void 0),v([f()],$.prototype,`hasChanges`,void 0),v([f()],$.prototype,`availableModels`,void 0),v([f()],$.prototype,`loadingModels`,void 0),v([f()],$.prototype,`requireToolApproval`,void 0),v([f()],$.prototype,`smartToolDetection`,void 0),v([f()],$.prototype,`editingState`,void 0),$=v([w(`docks-ai-config-editor`)],$),i.registerContribution(p,{name:`aiview`,label:`AI Assistant`,icon:`robot`,component:e=>g`<docks-aiview id="${e}"></docks-aiview>`}),i.registerContribution(I,{label:`App Support`,description:`General-purpose assistant that can answer questions and execute app commands`,role:`appsupport`,priority:100,icon:`question-circle`,sysPrompt:R,tools:async()=>({enabled:!0,smartToolDetection:(await T.get(`aiConfig`))?.smartToolDetection??!1})}),i.registerContribution(h,{target:h,label:`Token Usage`,component:`<docks-token-usage></docks-token-usage>`}),b.registerEditorInputHandler({editorId:`system.ai-config-editor`,label:`AI Config`,ranking:1e3,canHandle:e=>e.key===`.system.ai-config`,handle:async e=>(e.component=t=>g`<docks-ai-config-editor id="${t}" .input=${e}></docks-ai-config-editor>`,e)}),o({command:{id:`open_ai_config`,name:`Open AI Configuration`,description:`Open the AI system configuration editor`,parameters:[]},handler:{execute:e=>{b.loadEditor({title:`AI Settings`,data:{},key:`.system.ai-config`,icon:`robot`,state:{}}).then()}}}),e.put(`aiService`,j);