const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-D9TjtA98-BvnYHyRG.js","assets/editor.main-rfbyGhyz.js","assets/main-D5lUwwMN.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-ANfeLLx--B-YLgL4b.js","assets/package-manager-C37NAVqq-DXtIXeLC.js"])))=>i.map(i=>d[i]);
import{l as o,b as s,F as c,_ as d,d as i}from"./main-D5lUwwMN.js";import{c as r}from"./ai-service-CZ0rzs7t-DY0HT22X.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-D9TjtA98-BvnYHyRG.js"),__vite__mapDeps([0,1,2,3,4,5,6]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
