import{n as e}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{A as t,a as n,at as r,ct as i,dt as a,ft as o,it as s,n as c,ot as l}from"./dist-CE3uCmPT.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};c.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>a`
                            ...
                            <div class="overlay-layer">
                                ${this.overlays.map(e=>e.type===`bbox`?a`
                                    <div
                                        ...
                                        title="${e.label??``}"
                                    >
                                        ${e.label?a`<span class="overlay-label">${e.label}</span>`:i}
                                    </div>
                                `:e.type===`mask`?a`
                                    <img
                                        class="overlay-mask"
    ...
    `}};t([r({attribute:!1})],h.prototype,`input`,void 0),t([s()],h.prototype,`mediaUrl`,void 0),t([s()],h.prototype,`imageNaturalWidth`,void 0),t([s()],h.prototype,`imageNaturalHeight`,void 0),t([s()],h.prototype,`overlays`,void 0),h=t([l(`docks-media-viewer`)],h);export{h as DocksMediaViewer};