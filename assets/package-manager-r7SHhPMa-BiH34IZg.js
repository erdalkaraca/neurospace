import{_ as e}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{A as t,O as n,at as r,ct as i,ft as a,j as o,ot as s,pt as c,st as l}from"./dist-Be2v51rR.js";var u=class extends i{constructor(...e){super(...e),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(e){this.packages=e.packages||[],this.pyenv=e.pyenv,this.onPackageAdded=e.onPackageAdded,this.onPackageRemoved=e.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(e){if(!e||e.trim()===``)return;let t=e.trim();this.packages.includes(t)||(this.packages=[...this.packages,t],this.onPackageAdded?.(t))}removePackage(e){this.packages.indexOf(e)>-1&&(this.packages=this.packages.filter(t=>t!==e),this.onPackageRemoved?.(e))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(e){this.packageLoadError=String(e)}finally{this.loadingPackages=!1}}}render(){let e;return a`
            <wa-dialog 
                ...
                <div slot="footer" class="package-manager-footer">
                    ${this.pyenv&&this.packages.length>0?a`
                        <wa-button 
                            variant="default"
    ...
    `}};o([s({type:Boolean})],u.prototype,`open`,void 0),o([s({type:Array})],u.prototype,`packages`,void 0),o([s({attribute:!1})],u.prototype,`pyenv`,void 0),o([r()],u.prototype,`loadingPackages`,void 0),o([r()],u.prototype,`packageLoadError`,void 0),u=o([l(`docks-python-package-manager`)],u);var d=new class{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement(`docks-python-package-manager`),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}};e.put(`pythonPackageManagerService`,d);export{d as t};