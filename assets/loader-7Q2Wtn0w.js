import{d as e,f as t}from"./fs-access-DHrXww7b-DkktKkYZ.js";import{D as n,E as r,I as i,M as a,P as o,R as s,T as c,V as l,a as u,b as d,c as f,ct as p,lt as m,z as h}from"./dist-BonTzzwu.js";import"./lit-xPPuxI3_.js";var g,_=`catalog.root`,v=class extends u{static{g=this}constructor(...e){super(...e),this.treeRef=c()}doBeforeUI(){this.rebuildTree(),this.contributionsSubscriptionToken=e(i,e=>{(e.target===`catalog.root`||e.target?.startsWith(`catalog.`))&&this.rebuildTree()})}doClose(){this.contributionsSubscriptionToken&&=(t(this.contributionsSubscriptionToken),void 0),super.doClose()}rebuildTree(){let e=l.getContributions(_);this.rootNodes=this.toTreeNodes(e),this.requestUpdate()}renderToolbar(){return p`
            <lyra-command
