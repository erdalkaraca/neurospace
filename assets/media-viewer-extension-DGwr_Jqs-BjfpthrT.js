import{n as e}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{at as t,ft as n,j as r,lt as i,n as a,o,ot as s,pt as c,st as l}from"./dist-Be2v51rR.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};a.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>n`
                            ...
                            <div class="overlay-layer">
                                ${this.overlays.map(e=>e.type===`bbox`?n`
                                    <div
                                        ...
                                        title="${e.label??``}"
                                    >
                                        ${e.label?n`<span class="overlay-label">${e.label}</span>`:i}
                                    </div>
                                `:e.type===`mask`?n`
                                    <img
                                        class="overlay-mask"
    ...
    `}};r([s({attribute:!1})],h.prototype,`input`,void 0),r([t()],h.prototype,`mediaUrl`,void 0),r([t()],h.prototype,`imageNaturalWidth`,void 0),r([t()],h.prototype,`imageNaturalHeight`,void 0),r([t()],h.prototype,`overlays`,void 0),h=r([l(`docks-media-viewer`)],h);export{h as DocksMediaViewer};