import{n as e}from"./fs-access-DHrXww7b-DkktKkYZ.js";import{D as t,M as n,N as r,P as i,a,at as o,ct as s,lt as c,n as l}from"./dist-CW5PPpr9.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};l.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>s`
                            ...
                            <div class="overlay-layer">
                                ${this.overlays.map(e=>e.type===`bbox`?s`
                                    <div
                                        ...
                                        title="${e.label??``}"
                                    >
                                        ${e.label?s`<span class="overlay-label">${e.label}</span>`:o}
                                    </div>
                                `:e.type===`mask`?s`
                                    <img
                                        class="overlay-mask"
    ...
    `}};t([r({attribute:!1})],h.prototype,`input`,void 0),t([n()],h.prototype,`mediaUrl`,void 0),t([n()],h.prototype,`imageNaturalWidth`,void 0),t([n()],h.prototype,`imageNaturalHeight`,void 0),t([n()],h.prototype,`overlays`,void 0),h=t([i(`lyra-media-viewer`)],h);export{h as LyraMediaViewer};