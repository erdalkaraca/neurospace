const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-D9TjtA98-D5J-EvS0.js","assets/editor.main-EWhBKaby.js","assets/main-v4CpkAwU.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-ANfeLLx--mgBo8i6a.js","assets/package-manager-C37NAVqq-F8BxVEzf.js"])))=>i.map(i=>d[i]);
import{l as o,b as s,F as c,_ as d,d as i}from"./main-v4CpkAwU.js";import{c as r}from"./ai-service-CZ0rzs7t-DSo8anio.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-D9TjtA98-D5J-EvS0.js"),__vite__mapDeps([0,1,2,3,4,5,6]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
